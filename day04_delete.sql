...
-- Yazili notu 84'ten buyuk olan olan cocuklari silin
...
-- Id'si 124'ten buyuk olan kayitlari silin :
 ...
 delete from cocuk
 where id > 124; -- bu satirda belli sartlari tasiyan ver'leri sildik
 
 savepoint cilek; -- olusturdugumuz yeni bir alana database'imizin bir kopyasini koyduk

rollback to cilek; -- bir satirda ise yaptigimiz degisiklikleri savepoint cilek durumundaki haline geri dondurduk
